...
<head>
    ...
    <link rel="stylesheet" href="../visuals/user/book_info_style.css">
    <link rel="stylesheet" href="../visuals/user/stars.css">
...
<body>
    <div class="wrapper collapse">
        ...
        <div class="main_container">
            ...
            WHERE book.book_id = $BOOK_ID AND book_review.review_book_id_FK = $BOOK_ID AND book.book_genre_FK = book_genre.genre_id

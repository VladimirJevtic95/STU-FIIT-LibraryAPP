...
$sql = "SELECT person_id FROM person WHERE person_role_FK = 2";
...
<body>
    ...
    <div class="wrapper collapse">
        <div class="top_navbar">
            ...
            <div class="top_menu">
                <div class="logo">
                    <?php
                    echo "<p class='welcomeUser'>" . $_SESSION["current_username"] . " -> all librarians</p>";
                    ?>
                </div>
                <ul>
                    <li>
    ...
    FROM person, roles WHERE person.person_role_FK = roles.role_id AND person.person_role_FK = 2
                        ...
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            <tbody>
                                <tr class="row100">
                                    ...
                                    <td class="column100">
                                        <a href='backend_logic/delete_worker.php?ID=<?php echo $row['person_id']; ?>&PAGE=<?php echo $page_number ?>&COLUMN=<?php echo $column ?>&ORDER=<?php echo $asc_or_desc ?>'><button class="btn_table">DELETE LIBRARIAN</button></a>
                                    </td>
                                </tr>
                            </tbody>
